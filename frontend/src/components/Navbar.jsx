...
export default function Navbar() {
  ...
  return (
    <nav className="w-full sticky top-0 z-50 bg-[#0a0a0f]/95 backdrop-blur-md border-b border-white/5">
      <div className="w-full max-w-[1600px] mx-auto px-6 h-16 flex items-center gap-6">
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="md:hidden border-t border-white/5 bg-[#0a0a0f] px-6 py-4 flex flex-col gap-2">
          {[['/', 'Home'], ['/browse', 'Browse'], ['/about', 'About']].map(([path, label]) => (
