...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[240px] shrink-0 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto bg-[#0f1016] py-6 flex-col gap-6 hidden md:flex">
              ...
              {section.items.map((item) => (
                ...
                >
                  <div className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 transition-colors ${
                    isActive(item.path) ? 'bg-white text-black' : 'bg-white/10'
                  }`}>
      ...
      <div className="px-5 mt-2 pb-2">
        <button className="w-full py-2.5 px-4 bg-white/10 hover:bg-white/20 text-white rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2">
